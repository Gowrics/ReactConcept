    ...
    return (
        <>
            <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'center', margin: '10px', gap: '20px' }}>
                ...
                <button className='btn btn-primary' onClick={() => handleFilterClick('Admin')}>ADMIN</button>
                <input
                    type='text'
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', textAlign: 'left', gap: '20px' }}>
                {filteredData.map((employee) => (
                    <div key={employee.id} style={{ margin: '10px', width: '25%', padding: '20px', border: '2px solid red' }}>
